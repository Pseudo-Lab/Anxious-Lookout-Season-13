...
set -euo pipefail
: "${NODE_PUBLIC_IPV4:?Set NODE_PUBLIC_IPV4 to the server public IPv4 address}"
...
printf '\n---\n'
sed "s/__NODE_PUBLIC_IPV4__/${NODE_PUBLIC_IPV4}/g" "$infra_dir/policies/node-protection.yaml.tpl"
